...
export const authUserEmail = createSelector(authState, (state) => state.authUser?.email)

export const authUserRole = createSelector(authState, (state) => state.authUser?.role)